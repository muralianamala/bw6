...
@XPathFunctionGroup(category = "URBANTIBCOCustomXPathFunction", prefix = "md5encrypt", namespace = "java://md5encrypt", helpText = "md5encrypt")
public class URBANTIBCOCustomXPathFunction {
